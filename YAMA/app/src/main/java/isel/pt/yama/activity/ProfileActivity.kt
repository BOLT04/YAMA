...
class ProfileActivity : AppCompatActivity() {
    ...
    /**
     * The responsibility of initializing currentUser property and otherUser ia on MainActivity
     * or LoginActivity. So when we're here, its guaranteed to be not null
     */
    private fun getUser(privateProfile: Boolean, repo: YAMARepository): User =
        if (privateProfile)
            repo.currentUser!!
        else
            repo.otherUser!!
